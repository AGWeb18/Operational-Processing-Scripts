...
claim_count_2018 = all_years_programs_models_2018.groupby(["program.type"])["quantity"].sum()
claim_count_2016 = all_years_programs_models_2016.groupby(["program.type"])["quantity"].sum()
...
#   Print descriptions - COUNT IS NOT ACCURATE FOR 2018 - SUM QUANTITY
claim_amount_2018 = all_years_programs_models_2018.groupby(["program.type"])["claim.amount"].sum()
claim_amount_2016 = all_years_programs_models_2016.groupby(["program.type"])["claim.amount"].sum()
...
count_amount_df.to_csv(r"C:\Users\aridding\Documents\BA Related\Reporting\Monthly\Monthly Report Development\April\Output\program_april.csv")#
