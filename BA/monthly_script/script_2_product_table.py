...
claim_count_2018 = all_years_programs_models_2018.groupby(["product.line"])["quantity"].sum()
claim_count_2016 = all_years_programs_models_2016.groupby(["product.line"])["quantity"].sum()
...
#   Print descriptions - COUNT IS NOT ACCURATE FOR 2018 - SUM QUANTITY
claim_amount_2018 = all_years_programs_models_2018.groupby(["product.line"])["claim.amount"].sum()
claim_amount_2016 = all_years_programs_models_2016.groupby(["product.line"])["claim.amount"].sum()
...
count_amount_df.to_csv(r"C:\Users\aridding\Documents\BA Related\Reporting\Monthly\Monthly Report Development\April\Output\product_april.csv")#
